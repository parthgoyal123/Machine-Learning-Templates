...
# -*- coding: utf-8 -*-
"""
Created on Fri Jan 18 11:39:19 2019
...
# ---> n_components: the number of independent variables that affect the dependent variable most
...
plt.legend()
plt.show()
fig.savefig('Kernel_PCA_training_Social.png')
...
plt.legend()
plt.show()
fig.savefig('Kernel_PCA_test_Social.png')
